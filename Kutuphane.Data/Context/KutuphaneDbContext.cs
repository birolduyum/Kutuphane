...
namespace Kutuphane.Data.Context
{
    public class KutuphaneDbContext:DbContext
    {
        ...
        //        entity.Property(e => e.Id).HasColumnName("id").HasDefaultValueSql("nextval('account.item_id_seq'::regclass)").IsRequired(); ;
        //        entity.Property(e => e.Id).HasColumnName("AuthorID").HasColumnType("int").HasDefaultValueSql("").IsRequired();
